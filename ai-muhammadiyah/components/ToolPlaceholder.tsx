...
export default function ToolPlaceholder({ tool }: ToolPlaceholderProps) {
  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center gap-4 px-6 py-10 text-center">
      <div className="grid h-16 w-16 place-items-center rounded-2xl bg-[var(--c-004d27)]/10 text-[var(--c-004d27)]">
        <Icon name={meta.icon} className="h-8 w-8" />
      </div>
      <h2 className="text-xl font-bold text-[var(--c-191c1d)]">{meta.title}</h2>
      <p className="max-w-sm text-sm leading-relaxed text-[var(--c-3f4940)]">
        {meta.description}
      </p>
