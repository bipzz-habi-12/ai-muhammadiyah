...
import type { Conversation } from "@/lib/mappers/types";
              ...
              {group.items.map((conversation) => {
                ...
                return (
                  <button
                    ...
                    className={
                      isActive
                        ? "flex w-full items-center gap-2 rounded-lg border-l-4 border-[#fdc003] bg-black/20 p-2 text-left"
                        : "flex w-full items-center gap-2 rounded-lg p-2 text-left transition hover:bg-white/5"
                    }
                  >
                    <Icon
                      name="chat"
