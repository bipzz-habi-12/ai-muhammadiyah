...
function cleanDocumentCharacters(text: string) {
  return text
    ...
    .replace(/[Ã¢â‚¬ÂÃ¢â‚¬â€˜Ã¢â‚¬â€™Ã¢â‚¬â€œÃ¢â‚¬â€]/g, "-")
    .replace(/(?:[ \t]*[|Ã¢â‚¬Â¢Ã‚Â·Ã¢â€”ÂÃ¢â€”Â¦Ã¢â€“ÂªÃ¢â€“Â«Ã¢â€“Â Ã¢â€“Â¡Ã¢â€”â€ Ã¢â€”â€¡]+[ \t]*){4,}/g, " ")
    .replace(/[ \t]+/g, " ");
}
...
function isListItem(line: string) {
  return /^([-*Ã¢â‚¬Â¢]|\d+[.)]|[a-zA-Z][.)])\s+/.test(line);
}
...
export function getEmptyDocumentMessage(documentType: SupportedDocumentType) {
  if (documentType === "pdf") {
